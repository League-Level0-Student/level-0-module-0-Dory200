...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String cheese = JOptionPane.showInputDialog("give an adjective or else" );
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("what drinks do you have in mind");
		// Get the player to enter a body part
		String body = JOptionPane.showInputDialog("enter a body part nowwwwww");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("ENTER A VERbBB");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("give me place pls");
		...
		String story = 
		"Piranhas are more "+ cheese +" during the day, so cross the river at\n"  +
